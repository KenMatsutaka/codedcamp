...
INSERT INTO MK_DRINK_TBL (DRINK_NAME, PRICE, INSERT_DATE, UPDATE_DATE, OPEN_STATUS, UPLOAD_FILE_NAME) VALUES
('ドクターペッパー', 130, now(), now(), 1, 'test.jpeg');

--在庫テーブル
CREATE TABLE MK_STOCK_TBL
(
...
INSERT INTO MK_STOCK_TBL (DRINK_ID, STOCK_COUNT, INSERT_DATE, UPDATE_DATE) VALUES
(1, 100, now(), now());
...
INSERT INTO MK_BUY_HISTORY_TBL (DRINK_ID, BUY_DATE) VALUES
(1, now());
...
(
    ...
    PIC NVARCHAR(255) COMMENT '画像ファイル'
)
DEFAULT charset=utf8
COMMENT 'ドリンクテーブル';

CREATE TABLE DRINK_STOCK_TBL
(
  DRINK_ID INT COMMENT 'ドリンクID',
